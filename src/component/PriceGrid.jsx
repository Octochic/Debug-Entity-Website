...
const PriceGrid = ({ plan, price, label, about }) => {  // Ensure `Label` is uppercase here too
    return (
        <div className='flex flex-col justify-center items-start bg-white px-6 pt-10 pb-20 rounded-xl gap-8 border-[3px] border-green-800'>
            ...
            <p className='bg-green-800 text-white text-center px-6 py-2 rounded-md text-[20px] font-bold hover:bg-green-500 hover:text-white cursor-pointer'>
                {label} 
            </p>
